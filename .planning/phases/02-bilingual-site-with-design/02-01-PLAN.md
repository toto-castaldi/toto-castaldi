...
1. Create `data/projects.toml` using TOML array-of-tables syntax (`[[project]]`). Define three projects:
   ...
   - Lumio: url = "https://lumio.toto-castaldi.com", logo = "" (empty -- logo not confirmed available)
   - Helix: url = "https://helix.toto-castaldi.com", logo = "" (empty -- logo not confirmed available)
